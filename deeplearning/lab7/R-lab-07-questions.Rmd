...
history <- model |>
  ...
  # if you do not have the time, you can run less than 100 epochs. Use fit().
...
history <- model |>
  fit(
    # TODO fit the model for 10 epochs,
    # periodically evaluating it on the validation data.
    # if you do not have the time, you can run less than 10 epochs. Use fit().
```
