...
add_gaussian_noise <- function(x, noise_fct) {
  # TODO add Gaussian noise to the input image and scale the noise by noise_fct
  x_noisy
}
...
output <- input |>
  # TODO add a layer that adds Gaussian noise to the input to make it a denoising autoencoder
  encoder() |>
  decoder()
